...
class Sunflower(Plant):
    def __init__(self,x,y):
        ...
        self.image = pygame.image.load('C:\\Users\\Allen W\\Desktop\\大软实践\\pvz1.0\\imgs\\sunflower.png')
...
class PeaShooter(Plant):
    def __init__(self,x,y):
        ...
        self.image = pygame.image.load('C:\\Users\\Allen W\\Desktop\\大软实践\\pvz1.0\\imgs\\peashooter.png')
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
        self.price = 50
...
class PeaBullet(pygame.sprite.Sprite):
    def __init__(self,peashooter):
        self.live = True
        self.image = pygame.image.load('C:\\Users\\Allen W\\Desktop\\大软实践\\pvz1.0\\imgs\\peabullet.png')
        self.damage = 50
        self.speed  = 10
        self.rect = self.image.get_rect()
...
class Zombie(pygame.sprite.Sprite):
    def __init__(self,x,y):
        ...
        self.image = pygame.image.load('C:\\Users\\Allen W\\Desktop\\大软实践\\pvz1.0\\imgs\\zombie.png')
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
        self.hp = 1000
